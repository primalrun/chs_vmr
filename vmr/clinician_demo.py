...
def clinician_audit_initial(clinician_attribute):
    ...
    for k in clinician_attribute:
        d1[k] = {'division': clinician_attribute[k][0],
                 ...
                 'state': clinician_attribute[k][3],
                 'clinic': clinician_attribute[k][4],
                 'coid': clinician_attribute[k][5],
                 'employed_status': clinician_attribute[k][6],
                 'clinician': clinician_attribute[k][7],
                 'specialty': clinician_attribute[k][8],
                 'fte': clinician_attribute[k][9],
                 'category': clinician_attribute[k][10],
                 'tenure': clinician_attribute[k][11],
                 'start_date': clinician_attribute[k][12],
                 'term_date': clinician_attribute[k][13],
                 'physician_flag': clinician_attribute[k][14],
                 'hospital_flag': clinician_attribute[k][15]
                 }
